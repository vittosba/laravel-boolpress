  ...
  methods: {
    getPosts: function getPosts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://127.0.0.1:8000/api/posts?page=".concat(page)).then(function (res) {
        console.log(res); // A. senza paginazione
        // this.posts = res.data;
        // B. con paginazione
    ...
    formaDate: function formaDate(postDate) {
  ...
  return _c(
    ...
    [
      ...
      _vm.posts
                ...
                return _c(
                  ...
                  [
                    ...
                    _c("div", { staticClass: "mb-4" }, [
                      _vm._v(_vm._s(_vm.formaDate(post.created_at))),
                    ]),
                    _vm._v(" "),
                    _c("p", [
        ...
        : _c("Loader", { attrs: { text: "Loading posts archive" } }),
    ],
    1
  )
}
...
var staticRenderFns = [
  function () {
    ...
    return _c("section", { staticClass: "container" }, [
      ...
      _vm._v(" "),
      _c("p", [_vm._v("Ther page you are looking for doesn't exist")]),
    ])
  },
]
render._withStripped = true
      ...
      _vm.post
        ? _c(
            ...
            [
              ...
              _vm._v(" "),
              _vm.post.cover
                ? _c("figure", { staticClass: "img-fluid" }, [
                    _c("img", {
                      attrs: {
                        width: "200",
                        src: _vm.post.cover,
...
module.exports = __webpack_require__(/*! /Users/vittoriosbardella/Desktop/boolean/ex/ex-20/laravel-boolpress/resources/js/front-office.js */"./resources/js/front-office.js");
